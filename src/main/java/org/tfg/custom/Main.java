...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String code = new String(Files.readAllBytes(Paths.get("/Users/TFG/Documents/TFG/backend/dji-connection/src/main/resources/instructions/instructions-square-routine.txt")));
