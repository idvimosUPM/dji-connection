...
public interface CustomDjiControllerVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitIntExpr(CustomDjiControllerParser.IntExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDoubleExpr(CustomDjiControllerParser.DoubleExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitStringExpr(CustomDjiControllerParser.StringExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFloatExpr(CustomDjiControllerParser.FloatExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIdExpr(CustomDjiControllerParser.IdExprContext ctx);
}