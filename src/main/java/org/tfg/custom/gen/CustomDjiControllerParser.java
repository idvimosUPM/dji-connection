...
public class CustomDjiControllerParser extends Parser {
    ...
    public static final int
            ...
            T__38 = 39, OR = 40, AND = 41, EQ = 42, NEQ = 43, GT = 44, LT = 45, GTEQ = 46, LTEQ = 47,
            PLUS = 48, MINUS = 49, MULT = 50, DIV = 51, MOD = 52, POW = 53, NOT = 54, ASSIGN = 55,
            TRUE = 56, FALSE = 57, NIL = 58, ID = 59, INT = 60, FLOAT = 61, STRING = 62, COMMENT = 63,
            SPACE = 64, OTHER = 65;
    public static final int
            ...
            RULE_while_stat = 18, RULE_condition_block = 19, RULE_stat_block = 20,
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                ...
                "assignmentStatement", "if_stat", "while_stat", "condition_block", "stat_block",
                "expr", "atom"
        };
    }
    ...
    private static String[] makeLiteralNames() {
        return new String[]{
                ...
                "'log'", "'imprimir'", "'if'", "'si'", "'else if'", "'sino si'", "'else'",
                "'sino'", "'while'", "'mientras'", "'{'", "'}'", "'||'", "'&&'", "'=='",
                "'!='", "'>'", "'<'", "'>='", "'<='", "'+'", "'-'", "'*'", "'/'", "'%'",
                "'^'", "'!'", "'='", "'true'", "'false'", "'nil'"
        };
    ...
    private static String[] makeSymbolicNames() {
        return new String[]{
                ...
                "TRUE", "FALSE", "NIL", "ID", "INT", "FLOAT", "STRING", "COMMENT", "SPACE",
                "OTHER"
        };
    }
    ...
    public final BlockContext block() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 576460962756820934L) != 0)) {
                    {
                        {
                            setState(49);
                            stat();
    ...
    public final Condition_blockContext condition_block() throws RecognitionException {
        ...
        enterRule(_localctx, 38, RULE_condition_block);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(165);
    ...
    public final Stat_blockContext stat_block() throws RecognitionException {
        ...
        enterRule(_localctx, 40, RULE_stat_block);
        try {
            setState(173);
            _errHandler.sync(this);
            switch (_input.LA(1)) {
