...
public interface CustomDjiControllerListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterIntExpr(CustomDjiControllerParser.IntExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code intExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitIntExpr(CustomDjiControllerParser.IntExprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code doubleExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterDoubleExpr(CustomDjiControllerParser.DoubleExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code doubleExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitDoubleExpr(CustomDjiControllerParser.DoubleExprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code stringExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterStringExpr(CustomDjiControllerParser.StringExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code stringExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitStringExpr(CustomDjiControllerParser.StringExprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code floatExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterFloatExpr(CustomDjiControllerParser.FloatExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code floatExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitFloatExpr(CustomDjiControllerParser.FloatExprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code idExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterIdExpr(CustomDjiControllerParser.IdExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code idExpr}
	 * labeled alternative in {@link CustomDjiControllerParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitIdExpr(CustomDjiControllerParser.IdExprContext ctx);
}